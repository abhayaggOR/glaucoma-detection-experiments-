"""
YOLO v11 Fine-Tuning (Last 3 Layers Only)
======================================================
Trains YOLO11s-cls and YOLO11l-cls on the augmented dataset using
standard cross-entropy loss, but FREEZES the first 8 layers.
Only layers 8, 9, 10 are trained.

Small model:  batch=16, epochs=200, patience=100
Large model:  batch=32, epochs=200, patience=75

Runs are saved under data_augment/runs13/
"""
...
RUNS_DIR = os.path.join(BASE_DIR, "runs13")

# Freeze first 8 layers (0 through 7)
FREEZE_LAYERS = 8

# ==============================================================
# STEP 1: TRAIN YOLO11s-cls (Fine-Tune)
# ==============================================================
print("=" * 60)
print("STEP 1: FINE-TUNING YOLO11s-cls (Layers 8, 9, 10 only)")
print("  epochs=200, batch=16, patience=100")
print("=" * 60)
...
print("\n✅ YOLO11s-cls fine-tuning complete")

# ==============================================================
# STEP 2: TRAIN YOLO11l-cls (Fine-Tune)
# ==============================================================
print("\n" + "=" * 60)
print("STEP 2: FINE-TUNING YOLO11l-cls (Layers 8, 9, 10 only)")
print("  epochs=200, batch=32, patience=75")
print("=" * 60)
...
results_l = model_l.train(
    ...
    freeze=FREEZE_LAYERS,
    project=RUNS_DIR,
    name="yolo11l_finetune",
    exist_ok=True,
)

print("\n✅ YOLO11l-cls fine-tuning complete")
...
for tag in ["yolo11s_finetune", "yolo11l_finetune"]:
