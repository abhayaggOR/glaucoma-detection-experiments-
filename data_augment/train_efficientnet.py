"""
EfficientNet B0–B3 Training — Augmented Data with Label Smoothing
==================================================================
Trains EfficientNet-B0, B1, B2, B3 (torchvision, pretrained on ImageNet)
...
B0: batch=16, epochs=300, patience=50 → runs7
B1: batch=16, epochs=300, patience=50 → runs8
B2: batch=32, epochs=300, patience=50 → runs9
B3: batch=32, epochs=300, patience=50 → runs10
...
combined_report_path = os.path.join(BASE_DIR, "EfficientNet_Training_Report.md")
