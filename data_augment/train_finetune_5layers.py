"""
YOLO v11 Fine-Tuning (Last 5 Layers Only)
======================================================
...
# To train the last 5 modules (6 to 10), we freeze the first 6 modules (0 to 5)
FREEZE_LAYERS = 6

# ==============================================================
# STEP 1: TRAIN YOLO11s-cls (Fine-Tune Last 5 Layers)
# ==============================================================
print("=" * 60)
print("STEP 1: FINE-TUNING YOLO11s-cls (Last 5 Layers)")
...
results_s = model_s.train(
    ...
    project=RUNS_DIR,
    name="yolo11s_finetune_5layers",
    exist_ok=True,
)

print("\n✅ YOLO11s-cls 5-layer fine-tuning complete")
